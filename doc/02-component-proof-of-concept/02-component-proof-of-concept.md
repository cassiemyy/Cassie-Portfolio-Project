...
Although I think all 3 designs could be fun, I am going to do the RollForSandwich component because it seems easy to implement because it would use arrays and random selection, which would be easier to code than aspects of the other components, and it overall is the more exciting one. I defined the kernel and secondary methods and can be used in a main method. I also don't think that the functionality of the component would get too difficult or have more complex data stuctures/logic.
