...
Representation: I will use five private String fields:
- bread
- protein
- cheese
- wildCard
...
Convention: None of the fields can be null but they can be empty strings if that part is missing.

Correspondence: The sandwich is exactly represented by the five fields:
bread, protein, cheese, wildCard, sauce
